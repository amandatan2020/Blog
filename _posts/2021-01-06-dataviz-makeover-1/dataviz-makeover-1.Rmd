...
Based on the above two observations, more questions on the linkage between labour force, working population, unemployment rates and birth rates surfaced. Some of these are mentioned in the lead-in statement that may have an impact on the resident labour force and the median age. The audience may be curious as to what exactly is the relationship and pattern of the other factors mentioned. As this dataviz is focused on re-visualising the current message, the additional data is not included in the final product.
