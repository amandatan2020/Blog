...
### 2. Proportion pattern of event type differs across countries
...
### 3. Number of events generally higher than fatalities, with some exceptions
...
### 4. Being 'large' does not mean 'significant'
...
Intuitively, one would think that higher number of events hold a more significant role in influencing the country's trend. The number of fatalities of the battles in Marawi contributes about 25% of the total fatalities of **battles** in the country (1,174 of 4,349). However, from the proportion chart in the country tooltip, **violence against civilians** holds the highest proportion of events, indicating that the sum of all the other little events in Philippines contributes more greatly to the country's total number of events.

### 5. Able to see how countries fare against others by event type

From the **Armed Conflict Event by Type** graph, the countries can be observed with relative to the overall median. If we highlight an individual country, the country's graphs will be highlighted and the country's median appears, and we can compare this to the overall median. Let us take a look at the top four countries: Myanmar, Philippines, Indonesia and Thailand.
...
For the remaining counties Malaysia, Laos, Vietnam and Cambodia, 
