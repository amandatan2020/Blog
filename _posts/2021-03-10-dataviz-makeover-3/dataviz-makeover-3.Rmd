...
### 2) Limited data and view specification capabilities

Both views provide the mouse-over view and selection functions (pointer and drag-box) to view more information, and the map view provides basic map interaction such as zoom, pan and added selection functions of radial and lasso selections. The features and usability of the interactivity will be discussed in detail next.
...
* Year order for the selected years changes: order does not make sense, even when compared to bar charts. The change is also subtle and might go undetected
...
### 3) Limited coordinated view


![Radial selection option after clicking on the descending sort button](critique/i3.jpg)



### 4) Country filtering

![Radial selection option after clicking on the descending sort button](critique/i4a.jpg)

![Radial selection option after clicking on the descending sort button](critique/i4b.jpg)
