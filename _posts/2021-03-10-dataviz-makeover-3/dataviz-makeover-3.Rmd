...
The proposed visualisation is designed using Tableau and uploaded on Tableau Public. The link can be found [here](https://public.tableau.com/views/DataViz_Makeover_03_Tableau/Dashboard1?:language=en&:display_count=y&:origin=viz_share_link).
...
After expanding, it was noted that there are more than 6K data points with unknown geographic locations.
...
4. Next, we will add the proportional symbol map to the dashboard by clicking-and-dragging it to the *Drop sheets here* area, as shown below.
...
8. We need to check the display of both graphs in the dashboard and make adjustments. At the map view, select a country e.g. Myanmar to check the map display. Notice that there are a lot of space on both sides of Myanmar in the map.

![](guide/089.jpg)

9. Under *Dashboard* *Size*, change the *Height* to **1500px**, and adjust the size of the map so that the Myanmar map is large enough and fills up most of the map view.

![](guide/090.jpg)

10. On the right column, *Period Range* filter is at the top, which is aesthetically not very pleasing. Click-and-drag a *Blank* object to the area above the filter until a grey box appears, as shown below.

![](guide/091.jpg)

11. Adjust filter and legend objects on the right column until satisfactory.

![](guide/092.jpg)

12. Continue to check the map view for the remaining countries. For Cambodia and Vietnam, the colour chosen is dark, which obscures the country's name and makes it difficult to see the data points. Let us change the colour by right-clicking on the colour legend and select *Edit Colors*.

![](guide/093.jpg)

13. For Cambodia, the colour *#D7CE9F* under *Miller Stone* colour palette is chosen.

![](guide/094.jpg)

14. For Vietnam, the colour *#BFBB60* under *Miller Stone* colour palette is chosen.

![](guide/095.jpg)

15. Coming back to Myanmar, notice that the *Battles* data points are large and still cover up the data points below it. This is because *Battles* are displayed at the top layer due to the sorting order of the event types.

![](guide/096.jpg)

16. Changing the order in one graph would affect all other graphs. To have better visual of the change, go to the *LineGraph* worksheet, click on the dropdown arrow beside **Event Type** and select *Sort...*.

![](guide/097.jpg)

17. At the *Sort [Event Type]* pop-up window, select **Field** under *Sort By* and keep the default values for the other fields.

![](guide/098.jpg){width=50%}

Return to the dashboard sheet and notice that data points of the other event types can now be clearly seen on the map for Myanmar.
...
18. Click-and-drag a *Vertical* object to the area below the *Country* legend.

![](guide/099.jpg)

19. Notice that a blank box will appear.

![](guide/100.jpg)

20. Next, click-and-drag the **Event Type** legend to the box, as shown below.

![](guide/101.jpg)

21. Then, click-and-drag the **Country** legend to the area within the box that is below the **Event TYpe** legend, as shown below.

![](guide/102.jpg)

22. To create a border for the vertical object encapsulating both the **Event Type** and **Country** legends, click on the *Layout* tab on the left and select the vertical object under *Item hierarchy*. Notice that the vertical box is selected on the dashboard.

![](guide/103.jpg)

23. Under *Border*, select the filled line and set the line thickness to the smallest.

![](guide/104.jpg){width=50%}

24. Next, add some prompters to indicate to the user by clicking-and-dragging the *Text* object to the top of the vertical box, as shown below.

![](guide/105.jpg)

25. The *Edit Text* window will pop up. Change the text as shown in the screen shot below.

![](guide/106.jpg){width=80%}

26. Standardise the wording of the remaining titles for the filters and legend, and make adjustments to the size and position.

![](guide/107.jpg)

27. The final product of the proportional map view and the controls are shown below.

![](guide/108.jpg)

28. Scroll down to check the line graph on the dashboard. The original title given to the graph is too long and adds visual clutter. We shall change it to **Armed Conflict Event by Type**, similar to the original data visualisation.

![](guide/109.jpg)

29. Last, we add the data source to provide information to the user on the data used. This is done by clicking-and-dragging a *Text* object to the bottom of the dashboard.

![](guide/110.jpg)

30. The second half of the dashboard is now complete!
