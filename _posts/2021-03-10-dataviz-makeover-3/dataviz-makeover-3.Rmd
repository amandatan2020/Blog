...
3. Click and drag **Event Type** to *Color* and **NumberRecord** to *Size* in the *Marks* card.
...
The information to be displayed includes number of events and fatalities by event type and the proportion of event types over the time.
...
3. Click-and-drag **Country** to *Detail* in the *Marks* card. Click-and-drag **Country** again, but this time to *Color*.
...
From the above, note that there is no data for Malaysia in 2015 and 2016, and Philippines in 2015. Let us take a closer look at Myanmar. In 2015, Myanmar experienced a high number of events, mainly **battles** with some **violence against civilians** in the northern region and **protests** in the central regions. In 2016 and 2017, there are visually less number of events in other parts of the country, except for the northern region. In 2018, the numbers picked up again across the country, with more **explosions** in the northern-most region, as compared to previous years. More recently in 2019 and 2020, the number of events seem to have shifted from the northern region to the north-western coast of the country.



Another interesting pattern noted is that of Thailand. From 2015 to 2019, the number of events is generally low, with the exception of Bangkok (having **protests** and **violence against civilians**) and the Thailand-Malaysia border (having a **variety of event types**). However, the number of **protests** is the highest in 2020 for Bangkok and more **protests** can be seen throughout the country. There was also visually significantly smaller number of events near the Thailand-Malaysia border.



### 2. Proportion of events changes over time

### 3. Individual location trend may differ from overall country trend

### 4. has the highest number of fatalities



### 5. Event type with highest number of conflicts concentrated in the Philippines
